...
#and 2 times for training inter model
    ...
    for cluster_epoch in range(args.cluster_epochs):
        ...
        #     }, False, fpath=osp.join(args.logs_dir, f'checkpoint_stage1_{cluster_epoch}_{epoch}.pth.tar'))
        ...
        mix_rate=0
        #for CCN faeture similarity, mix_rate=0 to not use jaccard sim
        ...
        for epoch in range(0, args.epochs_stage2):
            ...
            }, False, fpath=osp.join(args.logs_dir, f'checkpoint_stage2_{cluster_epoch}_{epoch}.pth.tar'))
...
#default=64
    parser.add_argument('-b2', '--batch-size-stage2', type=int, default=16)#change
    parser.add_argument('--instances', default=4)
    #default=4
    parser.add_argument('-j', '--workers', type=int, default=0)#change
