    ...
    def load(self, num_val=0.3, verbose=True):
        ...
        if query_names is not None:
            query_names = set(query_names)
                ...
                ###################create subset of query and gallery set####################
        """this reduce the number of identities(ids) to test, not reduce the number of images """
        query_ids=[ 1,3,4,5,416,959, 1208,1209]
        gallery_ids=[ 1,3,4,5,416,959, 1208,1209,567, 568, 574,  692, 693]
        # query_ids=[ 1,3,4,5,416,959]
        # gallery_ids=[4,5,416,959, 568]
